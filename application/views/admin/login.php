	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form id="loginform" method="post" action="<?php echo base_url(); ?>admin" class="login100-form">
					...
					<div class="text-center p-t-12">
						<a class="txt2" href="<?php echo base_url() ?>admin/forgot-password">	<span class="txt1">
							Forgot Password?
						</span>
