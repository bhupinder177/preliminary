                    ...
                    <div class="box bg-white rounded c-pass-sec">
                      ...
                      <div class="row">
                        <div class="col-md-10">
                         ...
                         <div class="col-md-2">
                          <a href="<?php echo base_url(); ?>admin/customer/add"   class="btn btn-success mb-0">Add Customer</a>
                        </div>
                              ...
                              <tbody class="customerdata">
                                ...
                                ?>
                                  <tr class="data">
                                      ...
                                      <td>
                                       <a href="<?php echo base_url(); ?>admin/customer/edit/<?php echo $r->userId; ?>"><i class="fa fa-edit"></i></a>&nbsp;
                                       <a class="deleterecord" data-link="<?php echo base_url(); ?>admin/customerDelete" data-id="<?php echo $r->userId; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                       </td>
                                  </tr>
                                <?php } }
                                     else
