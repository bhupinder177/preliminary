	...
	<tbody>
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" style="background:#fff; box-shadow:0 0 10px #ccc;" width="600">
              ...
              <img width="150px" src="<?php echo base_url(); ?>assets/image/logo.jpg" alt="">
            </td>
					</tr>
					<tr>
						<td>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tbody>
																	<tr>
																			 ...
																			 Dear <?php echo $name; ?>,
																			 <br/>
                                       <tr><td style="font-size: 16px;color: #6d6e73;">

                                 requested a new password via the forgotten password link.</td>

                                       </tr>
                                       <tr>
                                         <td >New Password : <?php echo $password; ?></td>
                                       </tr>
