				...
				<tbody>
					<tr>
						<td align="center" height="100" width="100" style="background:#c3c8ca;border-bottom:solid 1px #f5f5f5;" valign="middle">
							<img width="150px" src="<?php echo base_url(); ?>assets/front/images/logo.png" alt="">
							...
							<tbody>
								<tr>
                                    ...
                                    <td>
																			 Hi admin,
																			 <br/>
																			<p><b>Name: </b> <?php echo $postdata['name']; ?></p><br/>
																			<p><b>Phone:</b> <?php echo $postdata['phone']; ?></p><br/>
																			<p><b>Email:</b> <?php echo $postdata['email']; ?></p><br/>
																			<p><b>Message:</b> <?php echo $postdata['message']; ?></p><br/>


																		  <br/>Thanks,<br/>
																			 <br/>Freestockrobot</br>
																			<br/><br/>
                                    </td>
																	</tr>
																</tbody>
