...
/*
  ...
  |
 */
$config['rest_message_field_name'] = 'error_message';
...
// $config['auth_override_class_method_http']['wildcard_test_cases']['*']['options'] = 'basic';
   $config['auth_override_class_method_http']['ExpertController']['userSignup']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['userSignIn']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['forgotPassword']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['setAvailabilty']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['saveExpertAvailabilityTime']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getExpertAvailabilityTime']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getExpertBookings']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['savePostCode']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['postCodes']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['updateExpertBooking']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getServiceTypes']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['addServiceTypes']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getBookingDetail']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['delPostCodes']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['updateTableAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getTableAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['updateUserAvailability']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getPostCode']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['updatePostCode']['post'] = 'none';
   $config['auth_override_class_method_http']['ExpertController']['getExpertAvailabilitySlot']['post'] = 'none';
/*
  |--------------------------------------------------------------------------
...
/*
  ...
  |
 */
$config['rest_keys_table'] = 'hc_keys';
...
/*
  ...
  |
 */
$config['rest_key_column'] = 'security_key';

/*
 * REST Table user ref id Column Name
 * This column use for user ref id
 */
$config['rest_userid_column'] = 'userId';
